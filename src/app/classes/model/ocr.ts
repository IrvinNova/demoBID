...
export class Ocr {
    ...
    public allData(): boolean{
        ...
        return this.nombre.length >= 3 && this.aPaterno.length >= 3 && this.aMaterno.length >= 3 && ((this.claveElector.length >= 3 && this.validCurp() && this.validRFC() && this.ocr.length >= 3) || this.tipoID !== 'ine');
    }
